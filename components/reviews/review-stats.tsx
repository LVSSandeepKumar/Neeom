...
export function ReviewStats({ stats, isLoading }: { stats: any; isLoading: boolean }) {
  return (
            ...
            [...Array(4)].map((_, index) => (
              ...
              >
                <CardHeader>
                  ...
                  <CardTitle className="h-4 shimmer"></CardTitle>
                  <CardTitle className="h-2 shimmer"></CardTitle>
                </CardHeader>
                <CardContent className="shimmer h-2">
                </CardContent>
              </Card>
            )
          )
